...
describe('createHotToastAdapter — toast', () => {
  ...
  it('ui === toast → toast.error called with message by default', () => {
    ...
    expect(mockToastError).toHaveBeenCalledWith('Something went wrong', expect.any(Object))
  })
  ...
  it('entry.message function → called with error, result used as message', () => {
    ...
    expect(mockToastError).toHaveBeenCalledWith('resolved message', expect.any(Object))
  })
  ...
  it('fallback message: no entry.message, no error.message → "An error occurred"', () => {
    ...
    expect(mockToastError).toHaveBeenCalledWith('An error occurred', expect.any(Object))
  })
})
...
describe('createHotToastAdapter — clear / clearAll', () => {
  ...
  it('clear(code) — calls toast.dismiss with stored ID', () => {
    ...
    adapter.render(makeIntent({ ui: 'toast', error: { code: 'ERR_A', message: 'x' }, entry: { ui: 'toast' } }), {})
    adapter.clear('ERR_A')
