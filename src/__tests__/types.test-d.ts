...
import type { AppError, HandleResult, ErrorEngineConfig, RoutingStrategy, UIAction } from '../types'

// AppError without generics defaults to string for both TCode and TField
declare const appError: AppError
expectAssignable<{ code: string; context?: { field?: string; [key: string]: unknown } }>(appError)
